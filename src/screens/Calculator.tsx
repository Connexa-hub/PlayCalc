  ...
  return (
    <SafeAreaView style={styles.safeContainer}>
      ...
      <View style={styles.fixedIconRow}>
        ...
        <MaterialCommunityIcons name="function" size={28} color="#fff" />
      </View>
      ...
      <View style={[styles.container, { paddingBottom: tabVisible ? TAB_HEIGHT : 16 }]}>
        ...
        <Pressable style={styles.display} onPress={handleDoubleTap}>
          ...
          <Animated.Text style={[styles.resultText, { opacity: fadeAnim, transform: [{ translateY: slideAnim }] }]}>
            {result}
          </Animated.Text>
        </Pressable>
      ...
      {/* Animated tab bar */}
      <Animated.View style={[styles.fakeTabBar, { opacity: fadeTabAnim, transform: [{ translateY: slideTabAnim }] }]}>
...
const styles = StyleSheet.create({
  ...
  normalButton: { backgroundColor: '#1c1c1c' },
  ...
  buttonPressed: { shadowOffset: { width: -2, height: -2 }, shadowOpacity: 0.5, shadowRadius: 4, elevation: 2 },
